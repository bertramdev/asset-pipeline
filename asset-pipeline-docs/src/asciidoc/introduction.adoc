...
=== Release History
* July 2026
** 5.2.0 - Grails 8.0.0-M2 support, Srping Boot 4, dependency upgrades.
* January 2026
** Documentation migrated to GitHub Pages at https://wondrify.github.io/asset-pipeline/[https://wondrify.github.io/asset-pipeline/]. The old asset-pipeline.com site is no longer maintained.
* Feb 18, 2024
** 5.0.7 - Improvements to graal injection on various gradle build task formats
* Feb 6, 2024
** 5.0.6 - Fixing build gradle plugin to properly inject graal runtime dependencies during development runtime
* Dec 10, 2024 
