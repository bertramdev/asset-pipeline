...
----
plugins {
	id "cloud.wondrify.asset-pipeline" version "{project-version}"
}

dependencies {
  runtime 'cloud.wondrify:asset-pipeline-micronaut:{project-version}'
  //Example LESS or Sass Integration
  //assets 'cloud.wondrify:less-asset-pipeline:{project-version}'
